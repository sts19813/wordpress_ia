    ...
    <form method="POST" action="{{ route('admin.ai-articles.store') }}" id="ai-generation-form">
        ...
        <div class="row g-7">
            ...
            <div class="col-xl-4">
                    ...
                    <div class="card-body">
                        ...
                        <select name="ai_prompt_profile_id" class="form-select form-select-solid mb-3" required>
                            @foreach ($profiles as $profile)
                                <option value="{{ $profile->id }}" @selected((string) old('ai_prompt_profile_id', $profiles->firstWhere('is_default', true)?->id) === (string) $profile->id)>
                ...
                <button type="submit" class="btn btn-primary w-100" @disabled($sourcePosts->isEmpty())>

                ...
                <div class="card card-flush h-100">
                    ...
                    <div class="card-body pt-4">
                        <div class="row g-5 mb-6">
                            ...
                            <div class="col-6"><div class="text-muted fs-7">Imagen</div><div class="fw-bold">{{ $profile->use_source_image ? 'Original primero' : ($profile->generate_image ? 'Generada con IA' : 'No') }}</div></div>
                            <div class="col-6"><div class="text-muted fs-7">Respaldo IA</div><div class="fw-bold">{{ $profile->generate_image ? 'Sí · '.$profile->image_quality : 'No' }}</div></div>
                            <div class="col-6"><div class="text-muted fs-7">Archivo</div><div class="fw-bold">{{ ($profile->use_source_image || $profile->generate_image) ? strtoupper($profile->image_format ?: 'jpeg').' · '.($profile->image_compression ?: 85).'%' : '—' }}</div></div>

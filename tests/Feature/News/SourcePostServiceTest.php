...
class SourcePostServiceTest extends TestCase
{
    ...
    public function test_it_does_not_insert_duplicate_posts_with_the_same_url(): void
    {
        $sourceSite = SourceSite::query()->create([
            'name' => 'Fuente RSS',
            'url' => 'https://example.com/feed',
        ...
        $service = app(SourcePostService::class);
        $first = $service->storeNormalizedItem($sourceSite, [
            'titulo' => 'Título duplicado',
            'contenido' => 'Contenido REST',
            'contenido_html' => '<p>Contenido REST</p>',
            'fecha' => '2026-06-29T12:00:00-06:00',
            'url' => 'https://example.com/post',
            'categorias' => ['Noticias'],
            'tags' => [],
        ...
        $second = $service->storeNormalizedItem($sourceSite, [
            'titulo' => 'Título duplicado',
            'contenido' => 'Contenido RSS diferente',
            'contenido_html' => '<p>Contenido RSS diferente</p>',
            'fecha' => '2026-06-29T12:00:00-06:00',
            'url' => 'https://example.com/post',
            'categorias' => ['Noticias'],
            'tags' => [],
